...
![Tests](https://img.shields.io/badge/tests-139%20passing-2EA44F?style=flat-square)
![License](https://img.shields.io/badge/license-MIT-3178C6?style=flat-square)

Final Project from the Web Ambiance Programming course.

📁 The actual project — setup, architecture, and full documentation — lives in **[`SIGA/`](SIGA/README.md)**.
